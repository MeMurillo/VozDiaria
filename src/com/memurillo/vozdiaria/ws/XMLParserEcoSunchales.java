...
public class XMLParserEcoSunchales implements XMLParserInterface {
	// We don't use namespaces
    private static final String ns = null;
    private int cantNoticiasConf;
    
    public XMLParserEcoSunchales(String cantidadNoticiasConfiguradas){
    ...
    private Noticia readEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
    	...
    	return new Noticia(title, link, descripcion, Constantes.ELECODESUNCHALES);
    }
